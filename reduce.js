...
/*
Write a function called addKeyAndValue which accepts an array of objects and returns the array of objects passed to it with each object now including the key and 
...
function partition(arr, callback) {
    const firstArr = arr.filter(callback);
    const secondArr = arr.filter(function(El){
        return !callback(El);
    });
